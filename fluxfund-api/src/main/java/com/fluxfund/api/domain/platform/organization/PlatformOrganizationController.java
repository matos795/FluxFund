...
public class PlatformOrganizationController {
    ...
    private final PlatformOrganizationService service;
    ...
    public CreatePlatformOrganizationResponse create(
            @RequestBody @Valid CreatePlatformOrganizationRequest request) {
    ...
    public PlatformOrganizationDetailsResponse findById(
    ...
    public PlatformOrganizationResponse updateStatus(
            @PathVariable UUID organizationId,
            @RequestBody @Valid UpdatePlatformOrganizationStatusRequest request) {
