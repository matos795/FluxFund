...
class AccountRepositoryIntegrationTest {
        ...
        void shouldOnlyMoveBankCashWhenCreditCardStatementIsPaid() {
                ...
                assertThat(bankResult.getAccountId()).isEqualTo(bankAccount.getId());
                assertThat(bankResult.getIncomeAmount()).isEqualByComparingTo("0.00");
                assertThat(bankResult.getExpenseAmount()).isEqualByComparingTo("0.00");
                assertThat(bankResult.getTransferInAmount()).isEqualByComparingTo("0.00");
                assertThat(bankResult.getTransferOutAmount()).isEqualByComparingTo("600.00");
                assertThat(bankResult.getTransferNetAmount()).isEqualByComparingTo("-600.00");
                assertThat(bankResult.getTransactionCount()).isEqualTo(1L);
        }

        @Test
        void shouldExcludeTechnicalMovementsFromOperationalCashFlow() {
                ...
                assertThat(accountResult.getIncomeAmount()).isEqualByComparingTo("100.00");
                assertThat(accountResult.getExpenseAmount()).isEqualByComparingTo("40.00");
                assertThat(accountResult.getTransactionCount()).isEqualTo(2L);
        }

        private void createBankTransaction(
        ...
        private Account createCreditCardAccount(Organization organization, String name) {
        ...
        private CreditCardStatement createCreditCardStatement(
                ...
                statement.setName("Fatura Agosto 2026");
                statement.setClosingDate(LocalDate.of(2026, 8, 15));
                statement.setDueDate(LocalDate.of(2026, 8, 20));
        ...
        private void createCreditCardPurchase(
                ...
                transaction.setInterestAmount(BigDecimal.ZERO);
                transaction.setDiscountAmount(BigDecimal.ZERO);
                transaction.setDescription("Compra no cartão");
